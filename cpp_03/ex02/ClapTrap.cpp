...
ClapTrap::ClapTrap(void) {
	...
	this->_name = "nameless";
	std::cout << this->_name << " created with default CLAPTRAP constructor" << std::endl;
}
...
ClapTrap::ClapTrap(std::string name) {
	...
	this->_attackDamage = 0;
	this->_name = name;
	std::cout << this->_name << " created with parametric CLAPTRAP constructor" << std::endl;
}

ClapTrap::ClapTrap(ClapTrap const & src) {
	*this = src;
	std::cout << this->_name << " created with copy CLAPTRAP constructor" << std::endl;
}

ClapTrap::~ClapTrap(void) {
	std::cout << this->_name << " was destroyed with CLAPTRAP destructor" << std::endl;
}
